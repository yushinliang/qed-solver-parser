...
public class SemiJoinRuleUnique extends RelRule<SemiJoinRuleUnique.Config> {
	protected SemiJoinRuleUnique(Config config) {
		super(config);
	}
	...
	public interface Config extends EmptyConfig {
		...
		@Override
		default SemiJoinRuleUnique toRule() {
			return new SemiJoinRuleUnique(this);
		}

		@Override
		default String description() {
			return "SemiJoinRuleUnique";
		}
